    ...
    <AppLayout title="Create Event">
        <div class="max-w-3xl mx-auto space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-extrabold text-primary font-headline">Create Event</h1>
                    <p class="text-sm text-on-surface-variant mt-1">Schedule a new event</p>
                </div>
                <Link
